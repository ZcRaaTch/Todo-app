...
function App() {
  ...
  return (
    <>
      ...
      <div className="z-10 -translate-y-[12.6rem] lg:-translate-y-[17.6rem] w-full">
        <div className=" mx-auto my-6 mb flex justify-between w-[85%] sm:w-[75%] lg:w-[45%] md:w-[50%]">
          <h1 className="font-medium tracking-[0.5rem] lg:tracking-[0.7rem] text-[var(--color-light-primary)] text-3xl lg:text-5xl">
            TODO
          </h1>
          <ThemeButton />
        </div>
      ...
      <p className="  text-center text-[var(--color-light-secondary-3)] dark:text-[var(--color-dark-secondary-5)] lg:my-8 -translate-y-[12.6rem]">
